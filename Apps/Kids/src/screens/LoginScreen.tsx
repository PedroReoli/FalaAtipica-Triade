...
export const LoginScreen: React.FC = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* Botão de Credenciais - Canto Superior Direito */}
      <TouchableOpacity
              ...
              <View style={styles.usersGrid}>
                {mockUsers.map((user) => (
                  ...
                  >
                    ...
                    <View style={styles.userInfo}>
                      <Text style={styles.userLabel}>Idade:</Text>
                      <Text style={styles.userValue}>{user.idade} anos</Text>
                    </View>
...
const styles = StyleSheet.create({
  ...
  // Botão de Credenciais - Alinhado com o Header
  credentialsButton: {
    position: 'absolute',
    top: 54, // Alinhado com a altura do SafeAreaView + posição do header
    left: 16, // Mesmo padding do header
    zIndex: 100,
    width: 48,
    height: 48,
    borderRadius: 24,
